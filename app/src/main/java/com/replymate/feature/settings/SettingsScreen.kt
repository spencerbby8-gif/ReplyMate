...
@Composable fun SettingsScreen(theme: AppTheme, geminiConfigured: Boolean, onThemeChanged: (AppTheme) -> Unit, onPersonalization: () -> Unit, onGeminiSettings: () -> Unit, onBack: () -> Unit) {
